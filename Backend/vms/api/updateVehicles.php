...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['id']) && isset($_POST['vehicleNumber']) && isset($_POST['vehicleType']) && isset($_POST['capacity'])
        ...
        $result = $db->updateVehicles($vehicle_id, $vehicleNumber, $vehicleType, $capacity, $gasType, $chassisNumber, $engineNumber, $ownership, $maintenance);
        ...
        if ($result == 0) {
            ...
            $response['error'] = true;
            $response['message'] = "Something went wrong. Couldn't update the vehicle details.";
