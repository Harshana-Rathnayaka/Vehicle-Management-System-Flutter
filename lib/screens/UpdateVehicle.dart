...
class _UpdateVehicleState extends State<UpdateVehicle> {
  ...
  void initState() {
    setState(() {
      _vehicleNumberController.text = widget.vehicle['Vehicle_No'];
      vehicleType = widget.vehicle['Vehicle_Type'];
      _capacityController.text = widget.vehicle['Capacity'];
      gasType = widget.vehicle['Fuel_Type'];
      _chassisNumberController.text = widget.vehicle['Chassis_Number'];
      _engineNumberController.text = widget.vehicle['Engine_Number'];
      _ownership =
          widget.vehicle['Ownership'] == 'Own' ? Ownership.Own : Ownership.Rent;
      _maintenance = widget.vehicle['Maintenance'] == 'Active'
          ? Maintenance.Active
  ...
  Future<http.Response> _updateVehicle(vehicleId) async {
    setState(() {
      _loading = true;
    });
                      ...
                      GestureDetector(
                        onTap: () {
                          if (_formKey.currentState.validate()) {
                            ...
                            _updateVehicle(widget.vehicle['ID']).then((value) {
